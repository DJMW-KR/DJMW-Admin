package com.pss.djmw_admin.view.signin
...
import com.pss.djmw_admin.databinding.ActivitySignInBinding
import com.kakao.sdk.user.UserApiClient
import com.pss.djmw_admin.viewmodel.SignInViewModel
...
class SignInActivity : BaseActivity<ActivitySignInBinding>(R.layout.activity_sign_in) {
    ...
    fun clickKakaoLoginBtn(view: View) {
        binding.loading.settingVisibility(true)
            ...
            UserApiClient.instance
                .loginWithKakaoTalk(this) { oAuthToken: OAuthToken?, error: Throwable? ->
                    if (error != null) {
                        ...
                        binding.loading.settingVisibility(false)
