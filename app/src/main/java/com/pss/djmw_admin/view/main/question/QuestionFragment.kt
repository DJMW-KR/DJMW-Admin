...
import com.pss.djmw_admin.databinding.FragmentQuestionBinding
import com.pss.djmw_admin.view.main.question.adapter.QuestionViewPagerAdapter
...
class QuestionFragment : BaseFragment<FragmentQuestionBinding>(R.layout.fragment_question) {
    ...
    override fun init() {
        if (mainViewModel.eventGetUserInfo.value?.sex == null){
            binding.frame.settingVisibility(false)
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                initViewPager()
                initTabLayout()
                binding.frame.settingVisibility(true)
